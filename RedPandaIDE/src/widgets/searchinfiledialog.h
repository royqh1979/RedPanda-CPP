...
public:
    ...
    void findInFiles(const QString& keyword, SearchFileScope scope,
                     QSynedit::SearchOptions options, bool useRegex,
...
private:
   ...
   std::shared_ptr<SearchResultTreeItem> batchFindInEditor(
